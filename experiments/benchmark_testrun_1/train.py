if __name__ == "__main__":
    ...
    parser.add_argument("--project", type=str, default="benchmark_testrun_1", help="Project name for wandb.")
    ...
    # set the splitpath:    
    config["data_config"]["splitpath"] = str(Path(__file__).parent/f"splits/split_{args.fold}.json")
