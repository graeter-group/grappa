...
parser.add_argument("-o", "--opt_weight", type=float, default=1., help="Sampling factor for the opt-datasets (gen2/pepconf-dlc). Default: 1.0")
parser.add_argument("-s", "--scan_weight", type=float, default=1., help="Sampling factor for the torsion-scan-datasets (gen2-torsion/protein-torsion). Default: 1.0")
