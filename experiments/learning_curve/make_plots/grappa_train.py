...
if calc_deviations:
    ...
    for ds_name, ds in zip(ds_names, datasets):
        ...
        for j, p in enumerate(paths):
            ...
            if n_mols in data_energy[ds_name].keys():
...
lc_plot(data, title="Learning Curve", fontname="Arial", ylabel="Force RMSE [kcal/mol/Å]", show=False, plotpath=f"{foldername}", fit=False, logx=True, logy=False, ignore_n_worst=0, connect_dots=True, ignore_ns=args.ignore_ns)
...
lc_plot(data, title="Learning Curve", fontname="Arial", ylabel="Energy RMSE [kcal/mol]", show=False, plotpath=f"{foldername}", fit=False, logx=True, logy=False, ignore_n_worst=0, connect_dots=True, ignore_ns=args.ignore_ns, suffix="_energy")