...
for i,p in [(0,1),(1,10),(2,100),(3,1000)]:
    ...
    ds.calc_ff_data(forcefield=ff_ref, suffix="_ref")


    eval_data, _ = ds.evaluate(plotpath=str(param_weight), by_element=True, by_residue=True, suffix="", name="Grappa", fontsize=16, fontname="Arial", refname="QM", compare_name="Amber 99SBildn", compare_suffix="_ref")
