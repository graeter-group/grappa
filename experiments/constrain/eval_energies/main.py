...
for i,p in [(4,10000), (5,100000)]:
    ...
    eval_data, _ = ds.evaluate(plotpath=str(param_weight), by_element=True, by_residue=True, suffix="", name="Grappa", fontsize=16, fontname="Arial", refname="Amber ff99SBildn")
