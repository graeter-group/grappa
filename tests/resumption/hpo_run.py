...
lit_model_config = {
    ...
    "lr_decay": 0.8,
    "time_limit": 15,
    "finish_criterion": {1:50, 2:30, 4:20}, # {hours: max_early_stopping_val_loss} finishes sweep runs that are not promising
