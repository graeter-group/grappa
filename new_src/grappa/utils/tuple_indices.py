...
def torsion_indices(mol: Mol, reduce_symmetry: bool = True, only_torsion_sets:bool=False) -> Tuple[np.ndarray, np.ndarray]:
    ...
    """
    propers = construct_torsions(mol)
...
def construct_propers(mol, reduce_symmetry:bool=True, central_atom_position:int=3, only_torsion_sets:bool=False)->Union[Tuple[Set[Tuple], Set[Tuple]], List[Set[Tuple]]]:
    """
    Returns propers
