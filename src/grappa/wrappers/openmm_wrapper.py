...
class openmm_Grappa(Grappa):
    ...
    """
    def parametrize_system(self, system, topology, laplacian=False):
        """
        ...
        molecule = Molecule.from_openmm_system(openmm_system=system, openmm_topology=topology, laplacian=laplacian)
