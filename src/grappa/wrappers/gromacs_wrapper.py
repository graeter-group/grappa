...
class GromacsGrappa(Grappa):
    ...
    """
    def parametrize(self, top_path:Union[str, Path], top_outpath:Union[str, Path]=None, charge_model:str='amber99'):
        """
        ...
        Args:
            ...
            charge_model (str, optional): Defaults to 'amber99'. The charge model used to assign the charges. Possible values
                - 'amber99': the charges are assigned using a classical force field. For grappa-1.1, this is only possible for peptides and proteins, where amber99 refers to the charges from the amber99sbildn force field.
                - 'am1BCC': the charges are assigned using the am1bcc method. These charges need to be used for rna and small molecules in grappa-1.1.
        """
...
def main_(top_path:Union[str,Path], top_outpath:Union[str,Path]=None, modeltag:str='grappa-1.1', charge_model:str='amber99', device:str='cpu'):
