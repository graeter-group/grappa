...
CHARGE_MODELS = ['am1BCC', 'amber99'] # amber99: amber99ffsbildn-charges for peptides. The idea is that the tag 'amber99' can refer to different charge models for different types of molecules (which grappa can usually distinguish). e.g. one could train for rna on charges from some classical rna forcefield without introducing an additional tag.
